...
void TFTLCD_Init(void)
{
	...
	LCD_WriteCmd(0XA1);
	tftlcd_data.id=LCD_ReadData();
	tftlcd_data.id=LCD_ReadData();	//����0X57
	tftlcd_data.id<<=8;	 
	tftlcd_data.id|=LCD_ReadData();	//����0X61			
#endif
...
*/
	...
	LCD_WriteData(0x23);		//����1 
	LCD_WriteData(0x02);		//����2 Divider M = 2, PLL = 360/(M+1) = 120MHz
	LCD_WriteData(0x04);		//����3 Validate M and N values   
	delay_us(100);
	...
	LCD_WriteCmd(0xB0);		//����LCDģʽ
	LCD_WriteData(0x20);		//24λģʽ
	LCD_WriteData(0x00);		//TFT ģʽ 

	LCD_WriteData((SSD_HOR_RESOLUTION-1)>>8);//����LCDˮƽ����
	LCD_WriteData(SSD_HOR_RESOLUTION-1);		 
	LCD_WriteData((SSD_VER_RESOLUTION-1)>>8);//����LCD��ֱ����
	...
	LCD_WriteCmd(0xF0);	//����SSD1963��CPU�ӿ�Ϊ16bit  
	LCD_WriteData(0x03);	//16-bit(565 format) data for 16bpp 

	LCD_WriteCmd(0x29);	//������ʾ
	//����PWM���  ����ͨ��ռ�ձȿɵ� 
	LCD_WriteCmd(0xD0);	//�����Զ���ƽ��DBC
	LCD_WriteData(0x00);	//disable

	LCD_WriteCmd(0xBE);	//����PWM���
	LCD_WriteData(0x05);	//1����PWMƵ��
	LCD_WriteData(0xFF);	//2����PWMռ�ձ�
	LCD_WriteData(0x01);	//3����C
	LCD_WriteData(0xFF);	//4����D
	LCD_WriteData(0x00);	//5����E 
	
	LCD_WriteCmd(0xB8);	//����GPIO����
	LCD_WriteData(0x0F);	//4��IO�����ó����
	LCD_WriteData(0x01);	//GPIOʹ��������IO���� 
	LCD_WriteCmd(0xBA);
	LCD_WriteData(0X01);	//GPIO[1:0]=01,����LCD����
#endif
#if 1
	LCD_WriteCmd(0xE2);		//Set PLL with OSC = 10MHz (hardware),	Multiplier N = 35, 250MHz < VCO < 800MHz = OSC*(N+1), VCO = 360MHz
	LCD_WriteData(0x2C);		//����1 0x23--
	LCD_WriteData(0x02);		//����2 Divider M = 2, PLL = 360/(M+1) = 120MHz
	LCD_WriteData(0x04);		//����3 Validate M and N values   
	delay_us(100);
	LCD_WriteCmd(0xE0);		// Start PLL command
...
//	LCD_WriteCmd(0x21);		//������ɫȡ��	
	...
	LCD_WriteCmd(0xBC);	
	LCD_WriteData(0X12);//����ֵ	
	LCD_WriteData(0x17);//�Աȶ�ֵ	
	LCD_WriteData(0x2F);//���Ͷ�ֵ	
	LCD_WriteData(0XF1);	
	delay_ms(10);	 
#endif
...
//	LCD_WriteCmd(0xC2,0x00);	LCD_WriteData(0x00,0x03);
	...
	*/
...
#ifdef TFTLCD_SSD1963N
	LCD_WriteCmd(0xE2);  //Set PLL with OSC = 10MHz (hardware), Multiplier N = 35, 250MHz < VCO < 800MHz = OSC*(N+1), VCO = 360MHz
	// LCD_WriteData(0x23);  //OSC = 10MHz (hardware),//����1 
	LCD_WriteData(0x2C);  //OSC = 8MHz (hardware),///����1  
	LCD_WriteData(0x02);  //����2 Divider M = 2, PLL = 360/(M+1) = 120MHz
	//LCD_WriteData(0x54);  //����3 Validate M and N values
	LCD_WriteData(0x04);
	...
	LCD_WriteCmd(0xB8); //����GPIO����
	LCD_WriteData(0x0F); //GPIO3=output, GPIO[2:0]=output//GPIO is controlled by host; 4��IO���ó����
	LCD_WriteData(0x01); //GPIO0 ʹ��������IO���� 
	//LCD_WriteCmd(0xB7);

	LCD_WriteCmd(0xBA); //����GPIO����
	...
	LCD_WriteCmd(0xF0); //����SSD1963ͬCPU�ӿ�Ϊ16bit Set pixel data interface 
	LCD_WriteData(0x03); //16-bit(565 format) data for 16bpp PIC32MX only

	//LCD_WriteCmd(0xF1);

	LCD_WriteCmd(0x21); //����ͼ����ɫ��תģʽ

	LCD_WriteCmd(0xBC);//��Ҫ
	LCD_WriteData(0X80);//����ֵ
	LCD_WriteData(0X80);//�Աȶ�ֵ
	LCD_WriteData(0X80);//���Ͷ�ֵ
	LCD_WriteData(0x01);//����������
	delay_ms(10);
